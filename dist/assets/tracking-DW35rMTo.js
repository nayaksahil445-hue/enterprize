import{a as e,c as t,d as n,n as r,p as i,r as a}from"./utils-CR0nv3qr.js";/* empty css              */t()||(window.location.href=`/auth.html`),i();var o=new URLSearchParams(window.location.search).get(`id`);o?s():document.getElementById(`tracking-content`).innerHTML=`
