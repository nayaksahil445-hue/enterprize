...
const envApiUrl = import.meta.env.VITE_API_URL || import.meta.env.VITE_PUBLIC_API_URL || import.meta.env.VITE_APP_API_URL;
export const API_URL = envApiUrl || (isLocalhost ? 'http://localhost:5000/api' : 'https://jaganath-backend.onrender.com/api');
